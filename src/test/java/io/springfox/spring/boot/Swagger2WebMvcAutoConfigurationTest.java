...
/**
 * Unit tests for {{ @link Swagger2WebMvcAutoConfiguration }}.
 *
...
class Swagger2WebMvcAutoConfigurationTest {
    ...
    void testLoadsWhenEnabledPropertySet() {
        runner.withUserConfiguration(Swagger2WebMvcAutoConfiguration.class)
                .withPropertyValues("swagger.enabled=true")
                .run(context -> assertThat(context).hasSingleBean(Swagger2WebMvcAutoConfiguration.class));
    }
    ...
    void testNotLoadedWhenPropertyAbsent() {
        runner.withUserConfiguration(Swagger2WebMvcAutoConfiguration.class)
                .run(context -> assertThat(context).doesNotHaveBean(Swagger2WebMvcAutoConfiguration.class));
    }
}
